...
Click the *Getting Started with Application Migration Toolkit->* button at the bottom to advance to the next topic. You can also use the menu on the left to move around the instructions at will.
