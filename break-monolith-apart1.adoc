...
2021-02-24 17:58:18,615 INFO  [io.agr.pool] (Quarkus Main Thread) Datasource '<default>': Initial size smaller than min. Connections will be created when necessary
2021-02-24 17:58:19,897 INFO  [io.quarkus] (Quarkus Main Thread) inventory 1.0-SNAPSHOT on JVM (powered by Quarkus 1.7.6.Final-redhat-00014) started in 11.276s. Listening on: http://0.0.0.0:8080
2021-02-24 17:58:19,900 INFO  [io.quarkus] (Quarkus Main Thread) Profile dev activated. Live Coding activated.
2021-02-24 17:58:19,900 INFO  [io.quarkus] (Quarkus Main Thread) Installed features: [agroal, cdi, hibernate-orm, hibernate-orm-panache, jdbc-h2, mutiny, narayana-jta, resteasy, resteasy-jsonb, smallrye-context-propagation, smallrye-health]
----
...
[source,console]
----
    Liveness:   http-get http://:8080/health/live delay=0s timeout=10s period=30s #success=1 #failure=3
    Readiness:  http-get http://:8080/health/ready delay=30s timeout=10s period=30s #success=1 #failure=3
----
