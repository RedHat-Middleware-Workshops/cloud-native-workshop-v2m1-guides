...
INFO  [io.quarkus] (Quarkus Main Thread) inventory 1.0-SNAPSHOT on JVM (powered by Quarkus 2.13.7.Final-redhat-00003) started in 4.496s. Listening on: http://0.0.0.0:8080
...
[source,sh,role="copypaste"]
----
curl http://localhost:8080/services/inventory | jq== Continuous Testing
