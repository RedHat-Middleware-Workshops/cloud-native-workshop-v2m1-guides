...
2020-03-19 14:41:17,454 INFO  [io.quarkus] (main) inventory 1.0-SNAPSHOT (running on Quarkus 1.3.1.Final) started in 3.353s. Listening on: http://0.0.0.0:8080
...
oc annotate dc/inventory-quarkus app.openshift.io/vcs-uri=https://github.com/RedHat-Middleware-Workshops/cloud-native-workshop-v2m1-labs.git --overwrite && \
