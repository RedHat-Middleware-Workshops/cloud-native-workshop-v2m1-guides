...
----
mvn -f $PROJECT_SOURCE/cloud-native-workshop-v2m1-labs/monolith clean package
----
...
[source,sh,role="copypaste"]
----
mvn clean package -Popenshift -f $PROJECT_SOURCE/cloud-native-workshop-v2m1-labs/monolith
----
...
[source,sh,role="copypaste"]
----
oc start-build coolstore --from-file $PROJECT_SOURCE/cloud-native-workshop-v2m1-labs/monolith/deployments/ROOT.war --follow
----
