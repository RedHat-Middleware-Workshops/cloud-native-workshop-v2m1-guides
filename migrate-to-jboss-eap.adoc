...
Open the Issues report in the {{ MTA_URL }}[MTA Console^]:
...
https://access.redhat.com/documentation/en-us/red_hat_application_migration_toolkit/[RHAMT documentation^] for more
...
In the {{ MTA_URL }}[RHAMT Console^], navigate to `Applications` on the left menu and click
