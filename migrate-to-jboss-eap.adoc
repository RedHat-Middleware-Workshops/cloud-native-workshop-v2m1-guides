...
image::report_mdb_issues.png[MDB Issues, 900]
...
[TIP]
====
If you have the tab for the `weblogic-ejb-jar.xml` file open (or handy) you can quickly find it in the explorer by right-clicking on the tab and then selecting **Reveal in Explorer** as shown.  You can also use the kbd:[ALT+R] (or kbd:[Option+R] on Mac).

image:reveal_in_explorer.png[reveal-in-explorer, 500]
====
...
+
image::coolstore_binary_build.png[Binary build, 200]
