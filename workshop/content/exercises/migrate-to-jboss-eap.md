...
![codeready-workspace-import](%image_path%codeready-workspace-import.png)
...
![codeready-workspace-convert](%image_path%codeready-workspace-convert.png)

Choose **Maven** from the project configurations and then click on **Save**.

![codeready-workspace-maven](%image_path%codeready-workspace-maven.png)
...
![codeready-workspace-convert](%image_path%codeready-workspace-delete-jar.png)
...
![codeready-workspace-convert](%image_path%codeready-workspace-delete-weblogic.png)
...
![codeready-workspace-copy-login-cmd](%image_path%codeready-workspace-oc-login-copy.png)
